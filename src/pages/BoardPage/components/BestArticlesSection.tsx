...
import { getArticles } from "../../../api/itemApi";
...
import { BoardSectionTitle } from "../BoardStyles";

const BestArticlesContainer = styled.div`
  padding-top: 17px;
  padding-bottom: 24px;
...
const BestArticlesSection: React.FC = () => {
  // < 상태의 타입을 명시해줘야 하는 경우 >
  ...
  return (
    <>
      ...
      <BestArticlesContainer>
        <BoardSectionTitle>베스트 게시글</BoardSectionTitle>
