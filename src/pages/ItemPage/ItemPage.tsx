...
interface BackToMarketPageLinkProps {
    $pill: string;
}

const BackToMarketPageLink = styled(StyledLink)<BackToMarketPageLinkProps>`
    display: flex;
    align-items: center;
    gap: 10px;
    font-size: 18px;
    ...
    return (
        <>
            ...
            <Container>
                ...
                <ItemCommentSection productId={Number(productId)} />
