...
import EmptyIcon from "../../assets/empty-comment.svg";
import DefaultProfileImage from "../../assets/icons/ic-profile.svg";
...
const CommentThread: React.FC<CommentThreadProps> = ({ productId }) => {
  ...
  useEffect(() => {
    ...
    const fetchComments = async () => {
      ...
      try {
        const data: ProductCommentListResponse = await getProductComments({
          productId,
          params,
        });
