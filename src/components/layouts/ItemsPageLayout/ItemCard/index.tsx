...
const ItemCard = ({ value, category }: { value: Card; category: string }) => {
  ...
  return (
    <div className={styles[`${category}-card`]}>
      <img src={imgSrc} alt='상품 이미지' className={styles[`${category}-img`]} onError={handleImageError} onClick={cardClickHandler} />
      ...
      <div className={styles['card-favorite']}>
        <img src={heartEmptyImg} alt='배경없는 하트 이미지' className={styles['heart-empty-img']} />
