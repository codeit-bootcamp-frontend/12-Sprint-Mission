...
export default function Searchbar() {
  ...
  return (
    <div className='flex-1 flex items-center gap-2 rounded-xl px-4 py-2 bg-gray-100'>
      ...
      <input type='text' id='article-search' placeholder='검색할 상품을 입력해주세요' className='flex-1 bg-gray-100 outline-none' value={search} onChange={onChangeSearch} onKeyDown={onKeyDown} />
    </div>
  );
}
